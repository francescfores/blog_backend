...
//        $post->images()->save($post_img1);
        ...
        $post_content_type4_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'w-full flex flex-col gap-5 p-5 rounded-sm mt-5',
        ]);
        $post_content_type4_attr2 = PostContentTypeAttribute::create([
            'name' => 'title_styles',
            'value1' => 'w-full text_font_marvel text-lg font-semibold  text-textPrimary',
        ]);
        $post_content_type4_attr3 = PostContentTypeAttribute::create([
            'name' => 'title_label',
            'value1' => 'Lyft launching ',
        ]);
        $post_content_type4_attr4 = PostContentTypeAttribute::create([
            'name' => 'desc_styles',
            'value1' => 'w-full text-base font-normal leading-relaxed text-inherit antialiased text-textPrimary',
        ]);
        $post_content_type4_attr5 = PostContentTypeAttribute::create([
            'name' => 'desc_label',
            'value1' => ' The place is close to Barceloneta Beach and bus stop just 2 min by walk and near to "Naviglio" where you can enjoy the main night life in Barcelona. ',
        ]);
        ...
        $post_content8_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'bg-bgPrim -ml-5 -mb-8 -translate-y-3 relative h-10 w-10  rounded-full flex justify-center items-center',
        ]);
        $post_content8_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'icon_header_styles',
            'value1' => 'bg-bgPrim h-6 w-6 rounded-full flex justify-center items-center border-[3px] border-info text-info text-xs',
        ]);
        ...
        $post_content5_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'border-l-2 border-info bg-bgTern w-full flex flex-col gap-5 px-5 pt-5 rounded-sm',
        ]);
        ...
        $post_content6_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'border-l-2 border-info bg-bgTern w-full flex flex-col gap-5 p-5 rounded-sm mb-5',
        ]);
        ...
        $post_content7_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'p-5 relative m-0 h-full w-full shrink-0 overflow-hidden rounded-sm rounded-r-none',
        ]);
        $post_content7_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'img_styles',
            'value1' => 'rounded-xl border-solid border-8 border-neutral-900 h-full w-full object-cover',
        ]);
        ...
        $post_content6_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'w-full flex flex-col gap-5 p-5 rounded-sm',
        ]);
        $post_content6_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'text_styles',
            'value1' => 'w-full text-base font-normal leading-relaxed text-inherit antialiased text-textPrimary',
        ...
        $post_content5_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'w-auto flex flex-col gap-5 p-5 pr-2 rounded-sm',
        ]);
        $post_content5_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'text_styles',
            'value1' => 'w-full text_font_marvel text-2xl font-semibold  text-warning',
        ]);
        $post_content5_type_attr3 = PostContentTypeAttribute::create([
            'name' => 'text_label',
            'value1' => '&',
        ...
        $post_content6_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'w-auto flex flex-col gap-5 py-5 pr-5 rounded-sm',
        ]);
        $post_content6_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'text_styles',
            'value1' => 'w-full text_font_marvel text-2xl font-semibold  text-warning',
        ...
        $post_content6_type_attr1 = PostContentTypeAttribute::create([
            'name' => 'styles',
            'value1' => 'w-full flex flex-col gap-5 pb-5 px-5 rounded-sm',
        ]);
        $post_content6_type_attr2 = PostContentTypeAttribute::create([
            'name' => 'text_styles',
            'value1' => 'w-full text-base font-normal leading-relaxed text-inherit antialiased text-textPrimary',
